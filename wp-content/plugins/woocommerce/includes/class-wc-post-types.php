			...
			apply_filters( 'woocommerce_register_post_type_product',
				array(
					'labels'              => array(
							...
							'menu_name'          => _x( 'Talent', 'Admin menu name', 'woocommerce' ),
							'add_new'            => __( 'Add Talent', 'woocommerce' ),
							'add_new_item'       => __( 'Add New Talent', 'woocommerce' ),
							'edit'               => __( 'Edit', 'woocommerce' ),
							'edit_item'          => __( 'Edit Talent', 'woocommerce' ),
							'new_item'           => __( 'New Talent', 'woocommerce' ),
							'view'               => __( 'View Talent', 'woocommerce' ),
							'view_item'          => __( 'View Talent', 'woocommerce' ),
							'search_items'       => __( 'Search Talent', 'woocommerce' ),
							'not_found'          => __( 'No Talent found', 'woocommerce' ),
							'not_found_in_trash' => __( 'No Talent found in trash', 'woocommerce' ),
							'parent'             => __( 'Parent Talent', 'woocommerce' )
						),
					'description'         => __( 'Add New Talent Here', 'woocommerce' ),
					'public'              => true,
					'show_ui'             => true,
