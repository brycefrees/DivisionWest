        ...
        function sf_savepost_content_script_check( $post_id ) {
	        ...
	        if ( $post ) {
	            ...
	            if ( function_exists( 'has_shortcode' ) ) {
	                ...
	                // Products
	                if ( has_shortcode( $content, 'product_category' ) || has_shortcode( $content, 'featured_products' ) || has_shortcode( $content, 'products' ) || has_shortcode( $content , 'spb_products' ) || has_shortcode( $content , 'spb_products_mini' ) ) {
