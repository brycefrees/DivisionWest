	...
	if ( ! function_exists( 'sf_get_animations_list' ) ) {
		function sf_get_animations_list($return_array = false) {
		    $anim_array = array(
		        ...
		        __( "Bounce", "swift-framework-admin" )            	=> "bounce",
		        __( "Flash", "swift-framework-admin" )             	=> "flash",
		        __( "Pulse", "swift-framework-admin" )             	=> "pulse",
		        __( "Rubberband", "swift-framework-admin" )        	=> "rubberBand",
		        __( "Shake", "swift-framework-admin" )             	=> "shake",
		        __( "Swing", "swift-framework-admin" )             	=> "swing",
		        __( "TaDa", "swift-framework-admin" )              	=> "tada",
		        __( "Wobble", "swift-framework-admin" )            	=> "wobble",
		        __( "Bounce In", "swift-framework-admin" )         	=> "bounceIn",
		        __( "Bounce In Down", "swift-framework-admin" )     => "bounceInDown",
		        __( "Bounce In Left", "swift-framework-admin" )     => "bounceInLeft",
		        __( "Bounce In Right", "swift-framework-admin" )    => "bounceInRight",
		        __( "Bounce In Up", "swift-framework-admin" )       => "bounceInUp",
		        __( "Fade In", "swift-framework-admin" )            => "fadeIn",
		        __( "Fade In Down", "swift-framework-admin" )       => "fadeInDown",
		        __( "Fade In Down Big", "swift-framework-admin" )   => "fadeInDownBig",
		        __( "Fade In Left", "swift-framework-admin" )       => "fadeInLeft",
		        __( "Fade In Left Big", "swift-framework-admin" )   => "fadeInLeftBig",
		        __( "Fade In Right", "swift-framework-admin" )      => "fadeInRight",
		        __( "Fade In Right Big", "swift-framework-admin" )  => "fadeInRightBig",
		        __( "Fade In Up", "swift-framework-admin" )         => "fadeInUp",
		        __( "Fade In Up Big", "swift-framework-admin" )     => "fadeInUpBig",
		        __( "Flip", "swift-framework-admin" )             	=> "flip",
		        __( "Flip In X", "swift-framework-admin" )          => "flipInX",
		        __( "Flip In Y", "swift-framework-admin" )          => "flipInY",
		        __( "Lightspeed In", "swift-framework-admin" )      => "lightSpeedIn",
		        __( "Rotate In", "swift-framework-admin" )          => "rotateIn",
		        __( "Rotate In Down Left", "swift-framework-admin" ) => "rotateInDownLeft",
		        __( "Rotate In Down Right", "swift-framework-admin" ) => "rotateInDownRight",
		        __( "Rotate In Up Left", "swift-framework-admin" )  => "rotateInUpLeft",
		        __( "Rotate In Up Right", "swift-framework-admin" ) => "rotateInUpRight",
		        __( "Roll In", "swift-framework-admin" )            => "rollIn",
		        __( "Zoom In", "swift-framework-admin" )            => "zoomIn",
		        __( "Zoom In Down", "swift-framework-admin" )       => "zoomInDown",
		        __( "Zoom In Left", "swift-framework-admin" )       => "zoomInLeft",
		        __( "Zoom In Right", "swift-framework-admin" )      => "zoomInRight",
		        __( "Zoom In Up", "swift-framework-admin" )         => "zoomInUp",
		        __( "Slide In Down", "swift-framework-admin" )      => "slideInDown",
		        __( "Slide In Left", "swift-framework-admin" )      => "slideInLeft",
		        __( "Slide In Right", "swift-framework-admin" )     => "slideInRight",
		        __( "Slide In Up", "swift-framework-admin" )        => "slideInUp",
		    );
...
//			$logo_alt = get_bloginfo( 'name' );
			...
			if (!empty($config) && isset($config['enabled'])) {
				...
				foreach ($config['enabled'] as $item_id => $item) {
					...
					if ($item_id == "social") {
						...
						$aux_output .= '<div class="aux-item"><nav class="std-menu cart-wishlist"><ul class="menu">'. "\n";
						$aux_output .= sf_get_cart();
						$aux_output .= sf_get_wishlist();
						$aux_output .= '</ul></nav></div>'. "\n";
					} else if ($item_id == "supersearch") {
						$aux_output .= '<div class="aux-item"><a href="#" class="fs-supersearch-link">'.$supersearch_icon.'<span>'.__("Super Search", "swiftframework").'</span></a></div>'. "\n";
					} else if ($item_id == "overlay-menu") {
						$aux_output .= '<div class="aux-item"><a href="#" class="overlay-menu-link menu-bars-link"><span>'.__("Menu", "swiftframework").'</span></a></div>'. "\n";
	...
	*	------------------------------------------------
	*	@original - /swift-framework/content/sf-portfolio.php
	*
	================================================== */
